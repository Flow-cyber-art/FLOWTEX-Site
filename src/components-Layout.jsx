...
const NAV_LINKS = [
  ...
  { href: "/#faq", label: "FAQ" },
  { href: "/katalog-wad", label: "Katalog wad" },
  { href: "/dobor-posadzki", label: "Dobór posadzki" },
      ...
      <footer style={{ backgroundColor: COLORS.darkBg }}>
        <div className="max-w-7xl mx-auto px-5 md:px-8 py-12 grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm" style={{ color: COLORS.mutedOnDark }}>
              <li>
                <Link to="/realizacje" className="hover:opacity-80 transition-opacity">
                  Realizacje
                </Link>
              </li>
              <li>
                <Link to="/katalog-wad" className="hover:opacity-80 transition-opacity">
                  Katalog wad posadzek
                </Link>
              </li>
              <li>
                <Link to="/dobor-posadzki" className="hover:opacity-80 transition-opacity">

...
export default function ServicePage() {
  ...
  if (!service) {
    // Nieznany slug: renderujemy treść 404 pod tym samym URL-em zamiast
    // przekierowywać (przekierowanie JS-owe na nieistniejącą trasę "/404"
    // było widoczne dla Google jako "strona zawiera przekierowanie" —
    // patrz NotFound.jsx i App.jsx, trasa "*").
    return <NotFound />;
  }
  ...
  return (
    <>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Usługi", item: "https://www.flowtex.pl/#oferta" },
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            provider: {
              "@type": "LocalBusiness",
              name: "FLOWTEX Polska",
              url: "https://www.flowtex.pl/",
              telephone: "+48507394552",
              email: "kontakt@flowtex.pl",
            },
            areaServed: "PL",
            url: canonicalUrl,
            ...(realizationImage ? { image: realizationImage } : {}),
            hasOfferCatalog: {
              "@type": "OfferCatalog",
              name: `Zakres usługi: ${service.title}`,
      ...
      {/* Zdjęcie realizacji — pełna szerokość, spokojnie pod tekstem hero.
          Klikalne -> /realizacje: to jedyne miejsce na stronach usług, które
          kieruje do case studies, więc wcześniej ten link wewnętrzny w ogóle
          nie istniał (obrazek był czysto dekoracyjny). */}
      {realizationImage && (
        <div className="max-w-7xl mx-auto px-5 md:px-8 py-10 md:py-14">
          <Link to="/realizacje" className="relative block rounded-sm overflow-hidden group" style={{ border: `1px solid ${COLORS.borderOnLight}` }}>
            <img
            ...
            />
            <div
              className="absolute left-0 bottom-0 px-4 py-2 md:px-5 md:py-2.5 ft-mono text-[10px] md:text-[11px] tracking-wider uppercase flex items-center gap-2"
